...
@media (max-width:700px){
    #view-panel{padding-top:0 !important;}
    .vault-category-grid{margin-top:0 !important;padding-top:24px !important;}
}
...
<?php require_once __DIR__ . '/app/Vault/DashboardActions.php'; ?>
<?php endif; ?>
</div>
<script>
