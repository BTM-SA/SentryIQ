...
(function () {
    ...
    function setupSystemOptions() {
        ...
        boxes[1].style.display='none'; boxes[2].style.display='none';
        var options=document.createElement('div'); options.className='form-box system-options-panel'; options.style.marginTop='20px';
        options.innerHTML='<h3>System Tools</h3>' + '<a href="passkeys.php" class="system-option-link" style="display:block;padding:16px;margin-top:12px;border:1px solid #e9ecef;border-radius:10px;text-decoration:none;color:#212529;background:#fff;"><strong>🔑 Passkeys</strong><span style="display:block;margin-top:4px;color:#777;font-size:13px;">Manage the devices that can unlock your SentryIQ vault.</span></a>' + '<a href="system_log.php" class="system-option-link" style="display:block;padding:16px;margin-top:12px;border:1px solid #e9ecef;border-radius:10px;text-decoration:none;color:#212529;background:#fff;"><strong>🔐 System Log</strong><span style="display:block;margin-top:4px;color:#777;font-size:13px;">View security and authentication events recorded by SentryIQ.</span></a>' + '<a href="gallery_settings.php" class="system-option-link" style="display:block;padding:16px;margin-top:12px;border:1px solid #e9ecef;border-radius:10px;text-decoration:none;color:#212529;background:#fff;"><strong>🖼️ Gallery Settings</strong><span style="display:block;margin-top:4px;color:#777;font-size:13px;">Control WebP quality, thumbnail quality, thumbnail size, and transparency handling.</span></a>';
