...
(function () {
    ...
    function setupSystemOptions(){
        ...
        options.innerHTML='<h3>System Tools</h3>'+
            ...
            '<a href="system_log.php" class="system-option-link" style="display:block;padding:16px;margin-top:12px;border:1px solid #e9ecef;border-radius:10px;text-decoration:none;color:#212529;background:#fff;"><strong>🔐 System Log</strong><span style="display:block;margin-top:4px;color:#777;font-size:13px;">View security and authentication events recorded by SentryIQ.</span></a><a href="storage.php" class="system-option-link" style="display:block;padding:16px;margin-top:12px;border:1px solid #e9ecef;border-radius:10px;text-decoration:none;color:#212529;background:#fff;"><strong>💾 Storage</strong><span style="display:block;margin-top:4px;color:#777;font-size:13px;">View cPanel account quota, used space, available capacity, and SentryIQ folder sizes.</span></a>'+
            '<a href="security-features.php" class="system-option-link" style="display:block;padding:16px;margin-top:12px;border:1px solid #e9ecef;border-radius:10px;text-decoration:none;color:#212529;background:#fff;"><strong>🛡️ Security Details</strong><span style="display:block;margin-top:4px;color:#777;font-size:13px;">Explore the security controls built into SentryIQ, including encryption, passkeys, session protection, CSRF protection, secure storage, and audit logging.</span></a>';
